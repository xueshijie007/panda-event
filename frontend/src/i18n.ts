...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    loginDescription: 'Use a local account. New users receive 10,000 virtual USDT. No real deposits, withdrawals, wallets, or live orders exist in this MVP.',
    username: 'Account',
    ...
    confirmOrder: 'Confirm Simulated Order',
    positions: 'Positions',
  ...
  zh: {
    ...
    loginDescription: '使用本地账户登录。新用户默认获得 10,000 虚拟 USDT。本 MVP 不支持真实充值、提现、钱包或真实下单。',
    username: '账户',
